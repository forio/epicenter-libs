...
epicenter.authentication.authenticate({accountShortName: "berkent", projectShortName: "foobar", handle: "david.berkman", password: "passw0rd", groupKey: "0000016c5387b8d2acbe17f8e6da0ca0a5a2", objectType: "user"})
    .then((foo) => {
        console.log(foo);
