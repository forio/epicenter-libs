...
new epicenter.authentication.Authentication().authenticate(new epicenter.authentication.AdminAuthenticationToken("dberkman@forio.com", "logos1174!"))
  .then(foo => {
    ...
    new epicenter.authentication.Authentication().upgrade(new epicenter.authentication.AdminUpgrade("berkteam"))
      .then(foo => {
        console.log(foo)

        new epicenter.account.Account().create(new epicenter.account.TeamAccountCreator("Berk Team", "berkteam", "12323", "ENTERPRISE", "YEARLY"))
